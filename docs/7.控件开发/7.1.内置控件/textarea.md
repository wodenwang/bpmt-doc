...
用于直接输入大文本的控件。
## 效果展示
![](../../assets/gitbook/7.控件开发/7.1.内置控件/7.1.textarea1.png)
## 参数API
| 序号 | 类型 | 说明  |
|:------:|:--------:|------------|
| 1|可选|宽度.<br>示例1(宽度800像素):textarea[800px]<br>示例2(宽度占外部区域90%):textarea[90%]|
|2|可选|高度.<br>示例1(宽度600像素,高度400像素):textarea[600px;400px]<br>示例2(宽度使用系统默认值,高度200像素):textarea[null;200px]|
## 界面脚本
|函数| 序号 | 类型 | 说明  |描述|
|:------:|:--------:|:--------:|:--------|:--------|
...
![](../../assets/gitbook/7.控件开发/7.1.内置控件/7.1.textarea2.png)
