...
| `5.模块视图/5.1.动态表视图.md` | `docs/concepts/module-views/dynamic-table-view.md` | 迁移后校准 | 待校准 | 是 | 待对照当前 UI 和代码 | 首批样板 |
...
| `6.脚本开发/6.1.上下文介绍.md` | `docs/developer-guide/scripts/context.md` | 迁移后校准 | 待校准 | 是 | 待对照脚本运行上下文 | 首批样板 |
| `6.脚本开发/6.2.内置函数/db.md` | `docs/reference/functions/db.md` | 迁移后校准 | 待校准 | 是 | 待对照函数实现 | 首批样板 |
| `7.控件开发/7.1.内置控件/text.md` | `docs/reference/widgets/text.md` | 迁移后校准 | 待校准 | 是 | 待对照控件实现 | 首批样板 |
| `8.用户权限/8.1.组织架构.md` | `docs/user-guide/permissions/organization.md` | 迁移后校准 | 待校准 | 是 | 待对照权限 UI 和数据 | 首批样板 |
