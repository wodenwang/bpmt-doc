...
```
![](../../assets/legacy-gitbook/6-scripts/db_demo1.png)
...
```
![](../../assets/legacy-gitbook/6-scripts/db_demo2.png)
...
```
![](../../assets/legacy-gitbook/6-scripts/db_demo3.png)

###示例2：
```groovy
db.query("select * from BS_CUSTOMER where BUSI_NAME like ?", "%广州%");
```
![](../../assets/legacy-gitbook/6-scripts/db_query2.png)
...
```
![](../../assets/legacy-gitbook/6-scripts/db_demo4.png)
...
```
![](../../assets/legacy-gitbook/6-scripts/db_demo5.png)
...
```
![](../../assets/legacy-gitbook/6-scripts/db_demo6.png)
...
```
![](../../assets/legacy-gitbook/6-scripts/db_demo7.png)
...
db.delete(vo);
```
![](../../assets/legacy-gitbook/6-scripts/db_demo8.png)
<br/>
`by Wilmer` 